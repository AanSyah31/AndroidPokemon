...
public class Pokemon {
    ...
    public Pokemon(int id, String num, String name, String img, List<String> type, String height, String weight, String candy, int candy_country, String egg, double spawn_chance, double avg_spawns, String spawn_time, List<Double> multipliers, List<String> weaknesses, List<Evolution> next_evolution, List<Evolution> prev_evolution) {
        this.id = id;
        this.num = num;
        this.name = name;
        this.img = img;
        ...
        this.weight = weight;
        this.candy = candy;
        this.candy_country = candy_country;
        this.egg = egg;
    ...
    public int getCandy_country() {
        return candy_country;
    }

    public void setCandy_country(int candy_country) {
        this.candy_country = candy_country;
    }
